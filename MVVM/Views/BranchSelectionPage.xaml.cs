...
public partial class BranchSelectionPage : ContentPage
{
    ...
    private void BuildBranchCards()
    {
        ...
        {
            var card = BuildCard(branch);
            BranchList.Children.Add(card);
        }
    }
    ...
    private View BuildCard(Mdl_Branch branch)
    {
        ...
        tap.Tapped += async (s, e) =>
        {
            ...
            {
                // ── Use Navigation from the page itself ───────
                Navigation = Navigation
            };

            vm.SetBranch(new Branches
            {
            ...
            await Navigation.PushAsync(new RatingPage(vm));
        };
